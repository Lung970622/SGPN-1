...
parser.add_argument('--epoch', type=int, default=150, help='Number of epochs [default: 50]')
parser.add_argument('--batch', type=int, default=8, help='Batch Size during training [default: 4]')
parser.add_argument('--point_num', type=int, default=4096, help='Point Number')
parser.add_argument('--group_num', type=int, default=30, help='Maximum Group Number in one pc')
parser.add_argument('--cate_num', type=int, default=4, help='Number of categories')
...
parser.add_argument('--input_list', type=str, default='data/indoor3d_ins_seg_hdf5/train_hdf5_file_list.txt', help='Input data list file')
