...
parser.add_argument('--input_list', type=str, default='data/indoor3d_ins_seg_hdf5/test_hdf5_file_list5.txt', help='Validation data list')
...
output_verbose = True  # If true, output all color-coded segmentation obj files
